import { getProposalById, updateProposalStatus } from '@/actions/proposal'
import { notFound } from 'next/navigation'
import Link from 'next/link'
import { ChevronLeft, FileText, Calendar, Building2, Download, Send, CheckCircle, XCircle } from 'lucide-react'
                            ...
                            {proposal.validUntil && (
                                <div className="flex items-center gap-3 p-3 bg-orange-50 rounded-xl text-orange-800">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs opacity-80">{new Date(proposal.validUntil).toLocaleDateString()}</div>
                                    </div>
                                </div>
                            )}
                        </div>
