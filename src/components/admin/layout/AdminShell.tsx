        ...
        <div className="flex min-h-screen bg-neutral-100 font-sans">
            ...
            `}>
                ...
                <div className="h-20 flex items-center justify-between px-6 border-b border-white/10">
                    ...
                    <button
                        onClick={() => setIsSidebarOpen(false)}
                        className="lg:hidden text-white/50 hover:text-white rounded-lg focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:outline-none"
            ...
            <div className="flex-1 lg:ml-72 flex flex-col min-h-screen">
                ...
                <header className="h-16 bg-white border-b border-neutral-200 flex items-center justify-between px-4 lg:px-8 sticky top-0 z-40">
                    <div className="flex items-center gap-4">
                        {/* Mobile Menu Button */}
                        <button
                            className="lg:hidden p-2 -ml-2 text-neutral-500 hover:bg-neutral-100 rounded-lg focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:outline-none"
                    ...
                    <div className="flex items-center gap-2 lg:gap-4">
                        <button
                            className="relative p-2 text-neutral-500 hover:text-neutral-900 hover:bg-neutral-100 rounded-lg transition-colors focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:outline-none"
