        ...
        return (
            <div className="max-w-md mx-auto bg-white p-8 rounded-2xl border border-neutral-200 shadow-lg">
                <div className="text-center py-8 animate-in fade-in zoom-in duration-300">
                    ...
                    <button
                        onClick={onReset}
                        className="text-sm text-brand-600 font-semibold hover:text-brand-700 flex items-center justify-center gap-2 mx-auto px-4 py-2 hover:bg-brand-50 rounded-lg transition-colors"
                    >
