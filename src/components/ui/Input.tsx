...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
    ({ className, type, error, leadingIcon, showPasswordLabel = "Şifreyi göster", hidePasswordLabel = "Şifreyi gizle", ...props }, ref) => {
            ...
            <div className="relative w-full group/input">
                ...
                {isPassword && (
                    <button
                        ...
                        className="absolute right-4 top-1/2 -translate-y-1/2 text-neutral-400 hover:text-neutral-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-500/20 focus-visible:ring-offset-2 rounded-md transition-colors"
