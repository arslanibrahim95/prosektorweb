            ...
            <div className="relative w-full group/input">
                ...
                {isPassword && (
                    <button
                        ...
                        className="absolute right-4 top-1/2 -translate-y-1/2 text-neutral-400 hover:text-neutral-600 focus:text-brand-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-500/20 focus-visible:rounded-lg transition-colors p-1"
