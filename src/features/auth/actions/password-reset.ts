...
export async function requestPasswordReset(prevState: ActionResponse<void>, formData: FormData): Promise<ActionResponse<void>> {
    try {
...
export async function resetPassword(prevState: ActionResponse<void>, formData: FormData): Promise<ActionResponse<void>> {
    try {
