...
export const TURKEY_PROVINCES: Province[] = [
  ...
  // 21 - Diyarbakir
  {
    ...
    slug: "diyarbakir",
    region: "guneydogu_anadolu",
    neighbors: [2, 12, 13, 23, 44, 47, 49, 63, 72],
    districts: [
  ...
  // 25 - Erzurum
  {
    ...
    slug: "erzurum",
    region: "dogu_anadolu",
    neighbors: [4, 8, 24, 29, 36, 49, 53, 75],
    districts: [
  ...
  // 38 - Kayseri
  {
    ...
    slug: "kayseri",
    region: "ic_anadolu",
    neighbors: [1, 2, 40, 46, 50, 58, 66, 68],
    districts: [
  ...
  // 42 - Konya
  {
    ...
    slug: "konya",
    region: "ic_anadolu",
    neighbors: [3, 6, 7, 32, 33, 38, 47, 51, 68, 70],
    districts: [
